...
animales = ['leon','perro', 'gato', 'jirafa', 'león','hipopótamo']
...
# ordenacion de texto es algo diferente
...
# pero sort tiene un problema, modifica la lista original( perdemos el dato anterior)
# para evitar esto python a creado un metodo parecido que tiene los mismos parametros sorted()
